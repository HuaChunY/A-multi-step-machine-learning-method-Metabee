...
source("Chunk01-R script for Metabee.R")#Loading the function
...
#####################Metabolites selection by Metabee
...
for (G in 1:2) {
  ...
  results <- Metabee(M_matrix,sam.lab)
  
  assign(paste0("DEM.",M[G]),results)
  
}


DEM1<-rbind(DEM.rawNEG$result,DEM.rawPOS$result)
